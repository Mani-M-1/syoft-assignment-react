...
const Signup = () => {
    const [form, setForm] = useState({firstname: '', lastname: '', email: '', password: '', phone: '', city: '', zipcode: '', acceptPrivacyPolicy: false});
    ...
    return (
        <div className="signup-page__bg-container">
            <div className="signup-page__left-section">
            ...
            <div className="signup-page__right-section">
                <form onSubmit={handleOnSubmit} className="signup-page__form-container">
                    <h1>Sign up</h1>
                    <p>Already have an account? <Link to="/login" className='signup-page__link-items'>Sign in</Link></p>

                    <label htmlFor='firstname'>First name *</label>
                    <input type='text' name='firstname' value={form.firstname} onChange={handleOnChangeInput} />
                    
                    <label htmlFor='lastname'>Last name *</label>
                    <input type='text' name='lastname' value={form.lastname} onChange={handleOnChangeInput} />
                    ...
                    <div className='signup-page__password-wrapper'>
                        ...
                        <button type='button' onClick={handlOnClickPasswordIcon}>
                            {showPassword ? <IoEyeOffSharp className='signup-page__password-icons' /> : <IoEye className='signup-page__password-icons' /> }
                        </button>
                    </div>

                    <label htmlFor='phone'>Phone Number *</label>
                    <input type='number' name='phone' value={form.phone} onChange={handleOnChangeInput} />

                    <label htmlFor='city'>City *</label>
                    <input type='text' name='city' value={form.city} onChange={handleOnChangeInput} />

                    <label htmlFor='zipcode'>Zipcode *</label>
                    <input type='number' name='zipcode' value={form.zipcode} onChange={handleOnChangeInput} />

                    <div className='signup-page__checkbox-and-policy-wrapper'>
                        <input type='checkbox' name='acceptPrivacyPolicy' checked={form.acceptPrivacyPolicy} onChange={handleOnClickCheckbox} />
                        <p>
                            I agree to the {" "}
                            <Link className='signup-page__link-items'>
                                Terms of Service
                            </Link> {" "}
                            and {" "}
                            <Link className='signup-page__link-items'>
